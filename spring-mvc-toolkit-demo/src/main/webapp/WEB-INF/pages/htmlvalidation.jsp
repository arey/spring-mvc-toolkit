...
<head>
<title>HTML 5 Validation page</title>
<style type="text/css">
...
<body>
	...
	<!-- 	should enable support for the placeholder attribute in INPUT fields at -->
	<!-- 	least for Internet Explorer 8+, Firefox and Opera. See http://diveintohtml5.org/detect.html  -->
